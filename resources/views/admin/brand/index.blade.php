...
@section('content')
    <div id="wrapper">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="_buttons">
                        <a onclick="addBrand(event)" class="btn btn-primary mright5 test pull-left display-block">
                            <i class="fa-regular fa-plus tw-mr-1"></i>
                            Thêm mới</a>
                            <a onclick="addExcel(event)" class="btn btn-primary mright5 test pull-left display-block">
                    ...
                    <div class="panel_s tw-mt-2 sm:tw-mt-4">
                        <div class="panel-body">
                            <div class="panel-table-full">
                                {{ $dataTable->table(['id' => 'brand_manage'], $footer = false) }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('template.modal', ['id' => 'showDetail_Modal', 'title'=>'Thêm Thương Hiệu', 'form'=>'brand.create'])
    @include('template.modal', ['id' => 'showImportView_Modal', 'title'=>'Thêm Thương Hiệu', 'form'=>'brand.import_view'])
@endsection
@push('script')
    {{ $dataTable->scripts() }}
    <script>
...
function ChangeToSlug()
        ...
        function addExcel(e) {
            ...
            document.getElementById('formBrand').reset();
            window.urlMethod = '/brand/import-view';
            window.type = 'POST';
        }
