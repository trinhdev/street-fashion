        ...
        <div class="content">
            <form action="{{ route('general_settings.edit') }}" id="settings-form" class=""
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
                            <li class="settings-group-general">
                                <a href="/admin/setting?group=general" data-group="general">
                            ...
                            <li class="settings-group-site_url">
                                <a href="/admin/setting?group=site_url" data-group="site_url">
                    ...
                    @include('admin.settings.includes.index', ['title'=> $title, 'view'=> $view])
