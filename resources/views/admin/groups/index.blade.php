    ...
    <div id="wrapper">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="_buttons">
                        <a href="#" class="btn btn-primary mright5 test pull-left display-block">
                    ...
                    <div class="panel_s tw-mt-2 sm:tw-mt-4">
                        <div class="panel-body">
                            <div class="panel-table-full">
                                {{ $dataTable->table(['id' => 'group_manage'], $footer = false) }}
                            </div>
                        </div>
                    </div>
                </div>
...
@push('script')
    ...
    <script>
        function deleteGroup(data){
            ...
            $.post('/groups/destroy', dataPost).done(function(response) {
                alert_float('success', response.message);
                $('#group_manage').DataTable().ajax.reload(null,false);
            });
        }
    </script>
@endpush
