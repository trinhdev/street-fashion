    ...
    <div id="wrapper">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="_buttons">
                        <a href="{{ route('role.create') }}" class="btn btn-primary mright5 test pull-left display-block">
...
@push('script')
    ...
    <script>
        function deleteRoles(data){
            ...
            $.post('/role/destroy', dataPost).done(function(response) {
                // alert_float('danger', 'Chức năng chưa hỗ trợ');
