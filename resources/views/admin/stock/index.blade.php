...
@section('content')
    <div id="wrapper">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="_buttons">
                        <a onclick="addStock(event)" class="btn btn-primary mright5 test pull-left display-block">
                    ...
                    <div class="panel_s tw-mt-2 sm:tw-mt-4">
                        <div class="panel-body">
                            <div class="panel-table-full">
                                {{ $dataTable->table(['id' => 'stock_manage'], $footer = false) }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('template.modal', ['id' => 'showDetail_Modal', 'title'=>'Form Categories', 'form'=>'stock.list'])
@endsection
@push('script')
    {{ $dataTable->scripts() }}
    <script>
...
function ChangeToSlug()
        ...
        function addCategories(e) {
            ...
            window.urlMethod = '/categories/store';
            window.type = 'POST';
        }
        ...
        function detailCategories(_this) {
            ...
            $.post('/categories/show', dataPost).done(function (response) {
                ...
                window.urlMethod = '/categories/update/' + $(_this).data('id');
                window.type = 'PUT';
            });
