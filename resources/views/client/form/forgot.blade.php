...
<div class="sm:mx-auto ">
    <h2 class="mt-6 text-center text-3xl font-bold text-white ">Quên mật khẩu</h2>
</div>
<div class="max-w-7xl mx-auto" >
    <div class="grid grid-cols-12 space-x-10  " >
        <div class=" col-span-3 flex justify-center items-center">
            <img style=" border-radius: 16px; height: 65vh" src="/img/form/hinh1q.jpg" alt="Image 1"  />
        </div>
            ...
            <div class="mt-8 w-100 relative z-10"> <!-- Đặt z-index cao hơn cho nội dung -->
                <div class="py-8 px-4 sm:rounded-lg">
                    <form class="space-y-6" action="{{ route('forgotpassword') }}" method="POST">
                        @csrf
                        <div>
                            <label for="email" class="block text-sm font-regular text-white">Email hoặc số điện thoại</label>
                            <div class="mt-1">
                                <input
                                    id="email"
                                    name="email"
