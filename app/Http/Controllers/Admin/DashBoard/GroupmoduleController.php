...
use App\Http\Controllers\Admin\admin\MY_Controller;
...
class GroupmoduleController extends BaseController
{
    ...
    {
        return $dataTable->render('admin.groupmodule.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.groupmodule.edit')->with('groupmodule', $groupmodule);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.groupmodule.edit')->with('groupmodule', $group_module);
    }
