...
class GeneralSettingsController extends BaseController
{
    ...
    public function index(Request $request, UrlSettingDataTable $settingDataTable, ModuleDataTable $moduleDataTable)
    {
        ...
        switch ($group) {
            ...
            case 'site_url':
                ...
                $view = 'admin.settings.includes.site-url';
                if ($request->ajax() && request()->get('table') == 'detail') {
                    return $settingDataTable->render('admin.setting.includes.site-url');
                }
                $data = [
            ...
            case 'info':
                ...
                $view = 'admin.settings.includes.information';
                $data = [];
                break;
            case 'misc':
                $title = 'Cài đặt khác';
        ...
        return view('admin.settings.list', compact('title', 'view', 'data'));
    }
    ...
    public function postEdit(Request $request)
    {
        ...
        if ($add_key) {
            $email_example = [
                'to'    => 'tuanhhcps30852@fpt.edu.vn',
                'cc'    => 'tuanhhcps30852@fpt.edu.vn',
                'bcc'   => ' ',
            ];
